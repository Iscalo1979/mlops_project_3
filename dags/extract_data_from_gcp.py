...
def load_to_sql(file_path):
    ...
    engine = sqlalchemy.Sadarin(f"postgresql+psycopg2://{conn.login}:{conn.password}@titanic-survival-prediction_304caa-postgres-1:{conn.port}/{conn.schema}")
